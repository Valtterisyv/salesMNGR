...
class User(db.Model, UserMixin):
    ...
    first_and_lastname = db.Column(db.String(50), unique=False, nullable=False)
...
class UserData(db.Model):
    ...
    three_avg_change_front = db.Column(db.Float, nullable=True)
    avg_change_front = db.Column(db.Float, nullable=True)
    good_percent_change_front = db.Column(db.Integer, nullable=True)
