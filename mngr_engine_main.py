...
REQUIRED_SALES_MONTH = int(15000)
            ...
            with app.app_context():
                ...
                if user:
                    ...
                    if my_sales_3_month_avg != three_avg_change:
                        three_avg_change_front = round(my_sales_3_month_avg - three_avg_change)
                        user.three_avg_change_front = three_avg_change_front
                        db.session.commit()
                    if my_sales_six_m_avg != avg_change:
                        avg_change_front = round(my_sales_six_m_avg - avg_change)
                        ...
                        if weekday_now != "Sat" or weekday_now != "Sun":
                            if time_now > "19:00":
                                ...
                                if good_percent != good_percent_change:
                                    good_percent_change_front = round(good_percent - good_percent_change)
